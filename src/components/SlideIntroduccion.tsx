    ...
    >
      ...
      >
        ...
        >
          ...
          <span className={`mt-6 text-xs uppercase tracking-widest font-bold opacity-0 group-hover:opacity-100 transition-opacity ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
            Descubrir
          </span>
        </div>
